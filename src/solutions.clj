...
(unit-test
  "problem91"
  (= true (my-is-connected? #{[:a :a]}))
  (= true (my-is-connected? #{[:a :b]}))
  (= false (my-is-connected? #{[1 2] [2 3] [3 1]
                               [4 5] [5 6] [6 4]}))
  (= true (my-is-connected? #{[1 2] [2 3] [3 1]
                              [4 5] [5 6] [6 4] [3 4]}))
  (= false (my-is-connected? #{[:a :b] [:b :c] [:c :d]
                               [:x :y] [:d :a] [:b :e]}))
  (= true (my-is-connected? #{[:a :b] [:b :c] [:c :d]
                              [:x :y] [:d :a] [:b :e] [:x :a]})))
